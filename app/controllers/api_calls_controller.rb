class ApiCallsController < ApplicationController
    ...
    def api_recipe_call
        ...
        request_inv = pantry.join(",")
        response = JSON.parse(RestClient.get "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?number=5&ranking=1&ignorePantry=true&ingredients=#{request_inv}",
            headers = {
